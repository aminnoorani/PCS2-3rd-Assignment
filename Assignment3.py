...
if __name__ == '__main__':
    ...
    plt.title("Efficiency of Binary tree")
    plt.show()
    ...
    plt.legend()
    plt.xlabel("Number of Inserted Elements")
    plt.ylabel("Total During (Milliseconds)")
    ...
    plt.xlabel("Number of Inserted Elements")
    plt.ylabel("Total Duration (Milliseconds)")
    plt.title("Comparison of Get_Mins")
    plt.show()
    ...
    plt.xlabel("Number of Inserted Elements")
    plt.ylabel("Total Duration (Milliseconds)")
    plt.title("Comparison of Get_Max")
    plt.show()
    ...
    plt.xlabel("Number of Inserted Elements")
    plt.ylabel("Total Duration (Milliseconds)")
    plt.title("Efficiency of Binary tree, Bubble sort, Quick sort, Heap sort")
    plt.show()
